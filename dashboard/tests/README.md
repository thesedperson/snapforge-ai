...
```text
[order-report] working directory: /path/to/snapforge
...
[order-report] reproduce with: /path/to/snapforge/venv/bin/python /path/to/snapforge/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
