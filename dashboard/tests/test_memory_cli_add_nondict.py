"""cmd_add (scripts/snapforge-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "snapforge-memory"
    loader = importlib.machinery.SourceFileLoader("snapforge_memory_cli_add", str(path))
