...
def _request(
    ...
    return SimpleNamespace(
        cookies={"snapforge_session": token},
...
def test_rename_research_respects_custom_data_dir(monkeypatch, tmp_path):
    """DEEP_RESEARCH_DIR (which honours SNAPFORGE_DATA_DIR) is used, not a
    hardcoded relative path. Before the fix, setting SNAPFORGE_DATA_DIR made
