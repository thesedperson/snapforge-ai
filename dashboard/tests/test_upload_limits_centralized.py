...
_LIMITS = {
    "GALLERY_UPLOAD_MAX_BYTES": ("SNAPFORGE_GALLERY_UPLOAD_MAX_BYTES", 100 * 1024 * 1024),
    "GALLERY_TRANSFORM_UPLOAD_MAX_BYTES": ("SNAPFORGE_GALLERY_TRANSFORM_UPLOAD_MAX_BYTES", 25 * 1024 * 1024),
    "MEMORY_IMPORT_MAX_BYTES": ("SNAPFORGE_MEMORY_IMPORT_MAX_BYTES", 10 * 1024 * 1024),
    "PERSONAL_UPLOAD_MAX_BYTES": ("SNAPFORGE_PERSONAL_UPLOAD_MAX_BYTES", 25 * 1024 * 1024),
    "EMAIL_COMPOSE_UPLOAD_MAX_BYTES": ("SNAPFORGE_EMAIL_COMPOSE_UPLOAD_MAX_BYTES", 25 * 1024 * 1024),
    "STT_MAX_AUDIO_BYTES": ("SNAPFORGE_STT_MAX_AUDIO_BYTES", 25 * 1024 * 1024),
    "ICS_MAX_BYTES": ("SNAPFORGE_ICS_MAX_BYTES", 10 * 1024 * 1024),
}
...
def test_routes_import_from_upload_limits_not_local_defs():
    ...
    forbidden = {
        "routes/gallery/gallery_routes.py": [
            'int(os.getenv("SNAPFORGE_GALLERY_UPLOAD_MAX_BYTES"',
            'int(os.getenv("SNAPFORGE_GALLERY_TRANSFORM_UPLOAD_MAX_BYTES"',
        ],
        "routes/memory/memory_routes.py": ['int(os.getenv("SNAPFORGE_MEMORY_IMPORT_MAX_BYTES"'],
        "routes/personal_routes.py": ['os.getenv("SNAPFORGE_PERSONAL_UPLOAD_MAX_BYTES"'],
