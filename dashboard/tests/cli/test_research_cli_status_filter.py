"""`snapforge-research list --status complete` was returning nothing.
...
Part of #2122 (snapforge-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "snapforge-research"
    loader = importlib.machinery.SourceFileLoader("snapforge_research_cli", str(path))
