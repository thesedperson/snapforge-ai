...
SnapForge email accounts currently use IMAP and SMTP with username/password
...
This is expected. SnapForge does not support Microsoft OAuth or Graph Mail yet,
