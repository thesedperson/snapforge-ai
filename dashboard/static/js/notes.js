...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('snapforge-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'snapforge-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'snapforge-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'snapforge-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'snapforge-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'snapforge-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'snapforge-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  pane.innerHTML = `
    ...
    <div class="notes-pane-header">
      <h4 class="notes-pane-title"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2.5px;margin-right:6px"><path d="M5 3h10l4 4v14H5z"/><path d="M15 3v5h5"/><path d="M8 17.5 15.5 10l2.5 2.5L10.5 20H8z"/></svg>AI Notes</h4>
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('snapforge-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'snapforge-note-draft-';
