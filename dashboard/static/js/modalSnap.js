...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'snapforge-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'snapforge-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('snapforge:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
