...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'SnapForge Logo',    group: 'Sidebar' },
...
const UI_SCALE_KEY = 'snapforge-ui-scale';
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'snapforge_' + (obj.name || 'theme') + '.json';
      a.click();
