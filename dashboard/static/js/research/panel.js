...
const _RESEARCH_HINTS = [
  "e.g. Trace SnapForge's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him",
...
const _SETTINGS_KEY = 'snapforge-research-settings';
const _COLLAPSE_KEY = 'snapforge-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('snapforge-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
