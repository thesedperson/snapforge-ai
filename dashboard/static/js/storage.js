...
// ── Key constants ──
export const KEYS = {
  THEME: 'snapforge-theme',
  TOGGLES: 'snapforge-toggles',
  ...
  MODELS_EXPANDED: 'snapforge-model-expanded',
  MODEL_ENDPOINTS: 'snapforge-model-endpoints',
  MODEL_SELECTED: 'snapforge-selected-model',
  SORT_ORDER: 'snapforge-sessions-sort',
  CHAT_SEARCH_SCOPE: 'snapforge-search-scope',
  INCOGNITO: 'snapforge-incognito',
  RAG_ACTIVE: 'snapforge-rag-active',
  MCP_ACTIVE: 'snapforge-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'snapforge-density',
  UI_SCALE: 'snapforge-ui-scale',
  WORKSPACE: 'snapforge-workspace'
};
