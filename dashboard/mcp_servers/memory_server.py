...
Imports MemoryManager and MemoryVectorStore from the SnapForge codebase.
"""
...
_OWNER_ENV_KEYS = ("SNAPFORGE_MCP_MEMORY_OWNER", "SNAPFORGE_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set SNAPFORGE_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
