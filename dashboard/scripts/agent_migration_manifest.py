...
This helper is intentionally read-only. It does not import the SnapForge
application package, write to data/, call an LLM, or apply anything. It turns
common agent export shapes into a portable JSON manifest that SnapForge can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral SnapForge agent migration manifest.")
