#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in SnapForge.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@snapforge.local mailbox. Password is stored Fernet-encrypted
...
NAME = "Demo"
IMAP_USER = "demo@snapforge.local"
