"""scripts/_lib/cli.py — shared scaffolding for the `snapforge-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("snapforge-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/snapforge-foo`
...
VERSION = "0.1.0"  # bumped centrally; every snapforge-* CLI reports this
