...
COPILOT_USER_AGENT = os.environ.get(
    "SNAPFORGE_COPILOT_USER_AGENT", "SnapForge/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "SNAPFORGE_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "SNAPFORGE_COPILOT_EDITOR_VERSION", "SnapForge/1.0"
)
