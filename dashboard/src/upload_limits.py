...
CHAT_UPLOAD_MAX_BYTES_ENV = "SNAPFORGE_CHAT_UPLOAD_MAX_BYTES"
...
# SNAPFORGE_*_MAX_BYTES env var to an integer byte count to tune it; an invalid
...
GALLERY_UPLOAD_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_GALLERY_UPLOAD_MAX_BYTES", 100 * 1024 * 1024
)
GALLERY_TRANSFORM_UPLOAD_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_GALLERY_TRANSFORM_UPLOAD_MAX_BYTES", 25 * 1024 * 1024
)
MEMORY_IMPORT_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_MEMORY_IMPORT_MAX_BYTES", 10 * 1024 * 1024
)
PERSONAL_UPLOAD_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_PERSONAL_UPLOAD_MAX_BYTES", 25 * 1024 * 1024
)
EMAIL_COMPOSE_UPLOAD_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_EMAIL_COMPOSE_UPLOAD_MAX_BYTES", 25 * 1024 * 1024
)
STT_MAX_AUDIO_BYTES = read_byte_limit_env(
    "SNAPFORGE_STT_MAX_AUDIO_BYTES", 25 * 1024 * 1024
)
ICS_MAX_BYTES = read_byte_limit_env(
    "SNAPFORGE_ICS_MAX_BYTES", 10 * 1024 * 1024
)
