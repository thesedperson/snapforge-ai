...
class MemoryProvider(ABC):
    """Base contract for SnapForge memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for SnapForge' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "SnapForge native memory"
