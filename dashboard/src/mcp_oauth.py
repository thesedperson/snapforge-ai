...
Registration, authorization-code + PKCE, token refresh) to SnapForge's web
...
# on SnapForge. APP_PORT is intentionally not used: it is only the Docker host
