...
user opening SnapForge, Cookbook, email, documents, notes, or other panels.
"""
...
def _browser_active_seconds() -> float:
    """How long a visible SnapForge browser heartbeat blocks background tasks."""
    try:
...
async def mark_browser_activity() -> None:
    """Record that an authenticated browser tab is visibly using SnapForge."""
