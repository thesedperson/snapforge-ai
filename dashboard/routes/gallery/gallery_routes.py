...
def _load_sam_backend():
    model_id = os.getenv("SNAPFORGE_SAM_MODEL", "facebook/sam-vit-base")
...
def _load_grounding_backend():
    model_id = os.getenv("SNAPFORGE_GROUNDING_MODEL", "google/owlvit-base-patch32")
...
def setup_gallery_routes() -> APIRouter:
    ...
    async def inpaint_proxy(request: Request):
        ...
        # Self-hosted diffusion server path. Newer SnapForge image
            ...
            async with httpx.AsyncClient(timeout=240) as client:
                try:
                    ...
                    if r.status_code not in (404, 405):
                        ...
                        # SnapForge diffusion_server.py has a dedicated
