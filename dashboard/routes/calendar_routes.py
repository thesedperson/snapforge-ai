...
# Override at deploy time via `SNAPFORGE_FALLBACK_OWNER` env var. In a real
# multi-user install set `SNAPFORGE_SINGLE_USER=0` so unauthenticated requests
# are rejected instead of silently writing to this address.
import os as _os
FALLBACK_OWNER = _os.environ.get("SNAPFORGE_FALLBACK_OWNER", "owner@localhost")
_SINGLE_USER_MODE = _os.environ.get("SNAPFORGE_SINGLE_USER", "1") != "0"
