...
INTERNAL_TOOL_TOKEN = os.environ.get("SNAPFORGE_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-SnapForge-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-SnapForge-Internal-Token), or
