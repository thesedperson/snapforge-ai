...
- [ ] I searched [open issues](https://github.com/snapforge-ai/snapforge/issues) and [open PRs](https://github.com/snapforge-ai/snapforge/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses SnapForge's existing visual language. Specifically:
