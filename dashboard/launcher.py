...
if getattr(sys, 'frozen', False):
    ...
    def show_splash_instantly():
        ...
        try:
            splash_root = tk.Tk()
            splash_root.title("SnapForge AI")
            ...
            tk.Label(splash_root, text="⛵ SnapForge AI", font=("Segoe UI", 22, "bold"), bg="#1a1c23", fg="#e06c75").pack(pady=(22, 2))
...
def create_tray_image():
    # Generate a beautiful 64x64 icon matching SnapForge AI brand red accent (#e06c75)
...
def setup_system_tray(url):
    try:
        ...
        menu = (
            pystray.MenuItem('Open SnapForge AI', lambda icon, item: on_open_browser(icon, item, url), default=True),
